  ...
  return (
    <div className="zk-container">
      <div className="zk-fitr">
        ...
        <p className="zk2">
        لا يراعى الحول في زكاة الزروع، بل يراعى الموسم والمحصول لقوله عز وجل:«وآتوا حقه يوم حصاده». فلو أخرجت الأرض أكثر من محصول في السنة وجب على صاحبها إخراج الزكاة عن كل محصول.
...
جاء في الحديث الصحيح:«ليس فيما دون خمسة أوسق صدقة» والخمسة أوسق تعادل ما وزنه (653) كيلوجراما من القمح ونحوه.
        ...
        <select value={ray} onChange={rayChange}>
        ...
        <div className="zk-button">
          ...
          <h3>مقدار الزكاة: {total + " كجم"}</h3>
          <h3>قيمة الزكاة: {total1 + " جنيه"}</h3>
        </div>
      </div>
    </div>
  );
